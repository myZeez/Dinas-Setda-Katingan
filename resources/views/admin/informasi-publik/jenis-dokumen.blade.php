                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-center pe-4">
                            <div class="btn-group btn-group-sm">
                                ...
                                <button type="button" class="btn btn-outline-danger" data-bs-toggle="modal" data-bs-target="#deleteModal{{ $jenis->id }}" title="Hapus">
                    ...
                    <div class="modal fade" id="deleteModal{{ $jenis->id }}" tabindex="-1">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title">Hapus Jenis Dokumen</h5>
                                    <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
                                </div>
                                <div class="modal-body">
                                    <p>Apakah Anda yakin ingin menghapus jenis dokumen:</p>
                                    <p class="fw-semibold">"{{ $jenis->nama }}"</p>
                                    @if($jenis->informasi_publiks_count > 0)
                                    <div class="alert alert-warning">
                                        <i class="bi bi-exclamation-triangle me-2"></i>
                                        Jenis dokumen ini memiliki {{ $jenis->informasi_publiks_count }} dokumen terkait dan tidak dapat dihapus.
                                    </div>
                                    @else
                                ...
                                <div class="modal-footer">
                                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Batal</button>
                                    @if($jenis->informasi_publiks_count == 0)
                                    <form action="{{ route('admin.informasi-publik.jenis-dokumen.destroy', [$kategori->slug, $jenis->id]) }}" method="POST" class="d-inline">
                                        @csrf
                                        @method('DELETE')
